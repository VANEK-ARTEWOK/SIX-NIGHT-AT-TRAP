...
int main()
{
    ...
    HDC MACK =txLoadImage ("ћј— ј .bmp");
    HDC Office =txLoadImage ("ќ‘»—bmp.bmp");
    HDC Office_LEFT =txLoadImage ("ќ‘»—2bmp.bmp");
    HDC Office_RIGHT =txLoadImage ("ќ‘»—3.bmp");
    HDC Office_DOOR =txLoadImage ("ќ‘»—2дверь.bmp");
