...
struct Door
  ...
  void draw()
 {
  ...
  txDrawText(520,240,830,285,"ÂÕÎÄ");
 }
 struct Car
 {
  int x4;
  ...
  void draw()
 {
  ...
  txDrawText(800,135,1300,330,"ÅÕÀÒÜ");
 }
struct Gay
 {
  int x;
...
int main()
   {
    ...
    ButtonStart btn_start = {495,215,855-495,300-215,"ÈÃÐÀÒÜ"};
    ButtonHelp btn_help = {495,345,855-495,432-345,"ÏÎÌÎÙÜ"};
    ButtonExit btn_exit = {495,485,855-495,580-485,"ÑÂÀËÈÒÜ"};

    Gay btn_gay = {643,486,60,100};

    ButtonHelp btn_door = {88,345,100,100,"ÂÕÎÄ"};
    ButtonExit btn_car = {900,290,366,120,"ÓÕÀÒÜ"};
    ...
    HDC Íelp =txLoadImage ("ÏÎÌÎÙÜ.bmp");
